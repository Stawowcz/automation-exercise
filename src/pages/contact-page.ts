...
export class ContactPage extends BasePage {
  ...
  public readonly submitSuccessText: Locator = this.page.locator('.status.alert.alert-success')
  public readonly getInTouchText: Locator = this.page.locator(".contact-form .title.text-center")
  public readonly noteText: Locator = this.page.locator('.contact-form div b')
  public readonly belowContactIsText = this.page.locator('.contact-form div', {hasText: ContactText.BELOW_CONTACT_IS})
